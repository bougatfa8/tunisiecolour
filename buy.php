...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand h1" href="index.php"> <i class="fa-thin fa-school"></i>Tunisie Couleur</a>
...
<div class="container">
  ...
  <div class="table-responsive">
    <table class="table table-bordered table-striped table-hover">
        ...
        $con= mysqli_connect('localhost','root','','prodisp');
        ...
        if(isset($_POST['submit'])){
          ...
          $totalement = trim($_POST['total']);
         $item = trim($_POST['itemsid']);
          print_r($username);
          echo "<br>";
          //print_r($files);
            ...
            $q = "INSERT INTO `orders`( `username`, `email`, `mobile`, `type`,`totalamt`,`itemsid`) VALUES ('$username','$email','$mobile','$type','$totalement','$item')";
